               ...
               <div className="w-full h-[800px] lg:h-[100dvh] flex flex-col justify-center bg-blue-900">
                    <div className="w-4/5 md:w-3/5 mx-auto p-5 md:px-[10%] md:py-20 flex flex-col gap-5 md:gap-5 bg-white border-black">
                         ...
                         <form action="" className="flex flex-col gap-5">
                              ...
                              <label className="flex flex-col">Password
                                   <div className="relative">
                                        ...
                                        <span className="absolute top-1 right-3  transform translate-y-1/2 cursor-pointer" onClick={togglePasswordVisibility}>
                              ...
                              <div className="flex justify-between">
                                   <div className="flex flex-row gap-5">
                                        <input type="checkbox" name="" id="" className="border border-black" />Remember me
                                   </div>
                                   <p className="font-roboto underline text-blue-900 font-normal"><Link>Forget password</Link></p>
                              </div>
                              <button type="submit" className="w-1/2 ms-auto bg-blue-900 text-white font-semibold py-2 rounded-[4px] font-roboto leading-normal">Sign In</button>
                         </form>
                         ...
                         <div className="flex flex-col gap-4 items-center">
                              ...
                              <p className="font-roboto font-normal">Don`t have an account? <span className="text-violet-950 cursor-pointer">
