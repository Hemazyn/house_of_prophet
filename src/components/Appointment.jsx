...
const facilitator = ["Bro Pelumi", "Bro Taiwo", "Bro Joshua", "Sister Dorcas"];
...
const Appointment = () => {
  ...
  const handleText = (ev) => {
    const selectedFacilitatorEmail =
      facilitatorEmails[ev.currentTarget.textContent];
  ...
  const itemList = () => {
    const list = facilitator.map((item) => (
      <div
        onClick={handleText}
        className="dropdown__item w-full"
        key={item.toString()}
        style={{ backgroundColor: "#c5c8fd" }}
      >
        <span>{item}</span>
      </div>
    ));
  ...
  return (
    <>
      ...
      <div className="w-full md:h-[800px] flex justify-center items-center bg-gray-300">
        <div
          id="appoint"
          className="w-full md:w-3/5 mx-auto flex flex-col shadow-2xl bg-opacity-60 backdrop-filter backdrop-blur-3xl p-3 md:p-5"
        >
          <h2 className="text-center font-roboto font-semibold text-black text-lg p-5">
            BOOK AN APPOINTMENT
          </h2>
          <form ref={form} onSubmit={sendEmail}>
            ...
            <div className="flex flex-row justify-between items-end mb-2">
              <div className="flex flex-col gap-1 w-fit">
                <label className="okay text-black font-roboto font-normal">
                  Choose meeting time
                </label>
                <input
                  type="date"
                  ...
                  onInvalid={(e) =>
                    e.target.setCustomValidity("Please choose a meeting date")
                  }
              ...
              <div
                className={
                  isOpen
                    ? "dropdown active"
                    : "flex flex-col font-roboto font-normal dropdown gap5 rounded-[4px] outline-none border-none text-[#0e1487] bg-indigo-200"
                }
                onClick={handleClick}
              >
                <div
                  className="dropdown__text flex items-center"
                  name="facilitator"
                >
            ...
            <div className="flex flex-col md:flex-row gap-x-5 gap-y-2 md:gap-y-0 text-black">
              <div className="flex flex-col w-full gap-5">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="rounded-[4px] font-roboto font-normal border border-black outline-none placeholder:text-xs px-2 py-2 bg-transparent"
                    onInvalid={(e) =>
                      e.target.setCustomValidity("Please input email address")
                    }
                    onInput={(e) => e.target.setCustomValidity("")}
                  />
                  <span className="text-xs font-roboto font-normal">
                    Get a notification 30 minutes before meeting
                  </span>
                </div>
                <div className="flex flex-col gap-2">
                  <label className="okay font-roboto font-normal">
                  ...
                  <PhoneInput
                    country={"ng"}
                    inputProps={{ required: true, name: "contact_number" }}
                    value={PhoneNumber}
                    ...
                    autoComplete="none"
                    onInvalid={(e) =>
                      e.target.setCustomValidity("Please input phone number")
                    }
                    onInput={(e) => e.target.setCustomValidity("")}
                  />
                  {!valid && (
              ...
              <div className="flex flex-col w-full gap-5">
                <div className="flex flex-col  gap-2">
                  <label className=" flex flex-row okay text-black font-roboto font-normal">
                  ...
                  <input
                    ...
                    onInvalid={(e) =>
                      e.target.setCustomValidity(
                        "Please input purpose of your message",
                      )
                    }
                    onInput={(e) => e.target.setCustomValidity("")}
                  />
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex flex-row gap-1 font-roboto font-normal">
                ...
                <button
                  type="submit"
                  className="w-1/2 ms-auto bg-blue-900 font-semibold py-2 rounded-[4px] font-roboto leading-normal text-white"
                >
                  Submit
                </button>
              </div>
