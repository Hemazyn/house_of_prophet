...
const NewsLetter = () => {
  ...
  return (
    <div className="flex flex-col items-center p-5 bg-yellow-500">
      <p className=" text-neutral-900 text-lg md:text-lg text-center font-normal font-roboto mb-3">
      ...
      >
        <label className="flex flex-col gap-1 font-roboto font-normal">
          ...
          <input
            ...
            onInvalid={(e) =>
              e.target.setCustomValidity("Please input first name")
            }
        ...
        <button
          type="submit"
          className="w-1/2 ms-auto text-white bg-blue-900 font-roboto font-semibold py-2 rounded-[4px] leading-normal"
        >
          Submit
        </button>
      </form>
